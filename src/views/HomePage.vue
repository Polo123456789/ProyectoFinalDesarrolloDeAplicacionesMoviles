  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true" class="app-container">
      ...
      <ion-fab slot="fixed" vertical="bottom" horizontal="end">
        <ion-fav-button class="button-add" >
        ...
        <div class="projects-section-line">
          <div class="projects-status">
            <div class="item-status">
              <span class="status-type">Historial</span>
            </div>
            ...
            <ion-card v-for="item in items" :key="item.placa" class="card-content"> 
                  
                <img class="car" alt="Foto Frontal" src="/assets/Honda.jpeg"/>
...
import RegisterTravelPage from './RegisterTravelPage.vue';
